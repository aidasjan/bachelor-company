...
@section('content')
    <div class='container'>
            ...
            <div class='col container_grey py-5'>
                ...
                <form action='{{ action('ProductFilesController@update', $product_file->id) }}' method='POST'>
                    ...
                    <div class='form-group col-md-4 offset-md-4 align-self-center'>
                        <label>Name</label>
                        <input type='text' value='{{$product_file->name}}' name='name' class='form-control'>
        ...
        <div class='row py-2'>
            <div class='col'>
                <a href="{{url('/files/documents/'.$product_file->id)}}" target="_blank" class='link_main'>VIEW FILE</a>
            </div>
        </div>
        <div class='row pb-3'>
            <div class='col'>
